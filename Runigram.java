...
public class Runigram {
	...
	public static Color[][] flippedVertically(Color[][] image){
		Color [][] verticalFlip = new Color [image.length][image[0].length];
		for (int i= 0; i < verticalFlip.length; i++){
			for (int j= 0; j < verticalFlip[0].length;j++){
				verticalFlip[i][j]=image [image.length - 1 - i][j];
			}
		}
		return verticalFlip;
	}
	...
	public static Color[][] grayScaled(Color[][] image) {
		Color [][] grayScale = new Color [image.length][image[0].length];
		for (int i = 0; i < image.length;i++){
			for (int j = 0; j< image[0].length; j++){
